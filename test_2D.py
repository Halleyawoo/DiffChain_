...
from dataloaders.dataset_chain.py import MRSEG19Normalization
from networks.UNet_UKAN import UNet_UKAN
...
def Inference(FLAGS, list=None):
    ...
    # test_save_path = FLAGS.ckpt.split('/ukan/')[0] + '/predictions/'
